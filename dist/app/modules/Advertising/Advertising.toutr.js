...
router.put('/update-ad', Advertising_controller_1.AdvertisingController.updateAdvertising);
router.get('/getAll-ad', Advertising_controller_1.AdvertisingController.getAdvertising);
router.delete('/delete-ad', Advertising_controller_1.AdvertisingController.deleteAdvertising);
