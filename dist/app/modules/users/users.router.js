...
router.patch("/:userId", users_controllar_1.usersContllors.updateSingleUser);
router.delete("/:userId", users_controllar_1.usersContllors.deleteSingleUser);
router.patch("/:userId", users_controllar_1.usersContllors.blockSingleUser);
router.patch("/:userId", users_controllar_1.usersContllors.activeSingleUser);
